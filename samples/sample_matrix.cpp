...
void main()
{
    ...
    cout << "1) Демонстрация базовых операций с матрицами:" << endl;
    TDynamicMatrix<int> a(4), b(4), c(4);
    for (int i = 0; i < 4; i++)
        for (int j = i; j < 4; j++)
        {
            a[i][j] = i * 5 + j;
    ...
    sym1(0, 0) = 2.5; sym1(0, 1) = 1.5;
    sym1(1, 1) = 3.5; sym1(1, 2) = 2.0;
    sym1(2, 2) = 4.0;

    sym2(0, 0) = 3.0; sym2(0, 1) = 2.0;
    sym2(1, 1) = 2.5; sym2(1, 2) = 1.5;
    sym2(2, 2) = 3.0;
    ...
    csr1.set(0, 0, 3.0); csr1.set(0, 1, 1.5);
    csr1.set(1, 1, 2.5); csr1.set(1, 2, 3.0);
    csr1.set(2, 0, 2.0); csr1.set(2, 2, 4.0);
    // Заполняем вторую CSR матрицу
    csr2.set(0, 0, 2.5); csr2.set(0, 2, 1.0);
    csr2.set(1, 1, 3.0); csr2.set(1, 2, 2.5);
    csr2.set(2, 0, 1.5); csr2.set(2, 1, 2.0);
